    ...
    return (
        <div>
            ...
            <section className="flex mt-3 ">
                <div className="w-1/2 mr-3 bg-white dark:bg-slate-900">
                    <div className="m-5 text-[#487ec1] font-bold">近八天系统访问记录</div>
                    <div className="ml-5" ref={ref} />
                </div>
                <div className="w-1/2 pl-3 bg-white dark:bg-slate-900">
